...
<body onload="load()">
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6 text-center text-md-left text-primary">
							<p class="mb-2 mb-md-0">SLIIT &copy; 2017-2020</p>
						</div>
	...
	<script type="text/javascript">
		...
		function save() {
			...
			if (doctorId === 0) {
				if (ValidInput()) {
					$
							.ajax({
								url : 'http://localhost:8080/rest.api/webresources/DoctorResources/Doctor',
								method : 'POST',
								headers : {
			...
			swal({
                ...
                dangerMode: true,
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                url: 'http://localhost:8080/rest.api/webresources/DoctorResources/Doctor/'+$('#doctorId').val(),
                                method: 'DELETE',
		...
		function load() {
			$
					.ajax({
						url : 'http://localhost:8080/rest.api/webresources/DoctorResources/Doctors',
						method : 'GET',
						headers : {
		...
		function search() {
			...
			if (searchID === "") {
				...
				$
						.ajax({
							url : 'http://localhost:8080/rest.api/webresources/DoctorResources/Doctor/'+searchID,
							method : 'GET',
							headers : {
								Accept : "application/json",
								"Content-Type" : "application/json"
