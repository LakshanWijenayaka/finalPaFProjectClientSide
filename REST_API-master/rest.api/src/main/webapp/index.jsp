...
<body onload="load()">
	...
	<script type="text/javascript">
		...
		function save() {
			...
			if (appointmentId === 0) {
				if (ValidInput()) {
					$
							.ajax({
								url : 'http://localhost:8080/rest.api/webresources/AppointmentResources/Appointment',
								method : 'POST',
								headers : {
			...
			swal({
                ...
                dangerMode: true,
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                url: 'http://localhost:8080/rest.api/webresources/AppointmentResources/Appointment/' + $('#appointmentId').val(),
                                method: 'DELETE',
		...
		function load() {
			$
					.ajax({
						url : 'http://localhost:8080/rest.api/webresources/AppointmentResources/Appointments',
						method : 'GET',
						headers : {
